...
private:
    void position(std::vector<std::vector<bool>> &possible_moves, unsigned int init_row, unsigned int init_col, int row_offset, int col_offset, board* _board);

    std::vector<std::vector<bool>> bishop_moves(unsigned int init_row, unsigned int init_col, std::vector<std::vector<bool>>& possible_moves, board* _board);
    std::vector<std::vector<bool>> knight_moves(unsigned int init_row, unsigned int init_col, std::vector<std::vector<bool>>& possible_moves, board* _board);
    std::vector<std::vector<bool>> rook_moves(unsigned int init_row, unsigned int init_col, std::vector<std::vector<bool>>& possible_moves, board* _board);
    std::vector<std::vector<bool>> pawn_moves(unsigned int init_row, unsigned int init_col, std::vector<std::vector<bool>>& possible_moves, board* _board);
    std::vector<std::vector<bool>> king_moves(unsigned int init_row, unsigned int init_col, std::vector<std::vector<bool>>& possible_moves, board* _board);
    std::vector<std::vector<bool>> queen_moves(unsigned int init_row, unsigned int init_col, std::vector<std::vector<bool>>& possible_moves, board* _board);

public:

    //from_diff constructor
    explicit Piece(std::string id);

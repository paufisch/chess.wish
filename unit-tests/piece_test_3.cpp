 ...
 */
class Piece_Test_3 : public ::testing::Test {
...
TEST_F(Piece_Test_3, Rook) {
    _legal_moves_expected[7][0] = true;
    _legal_moves_expected[7][1] = true;
    _legal_moves_expected[7][2] = true;
    _legal_moves_expected[7][3] = true;
    _legal_moves_expected[7][4] = true;
    _legal_moves_expected[7][5] = true;

    _legal_moves_expected[6][6] = true;
    _legal_moves_expected[5][6] = true;
...
TEST_F(Piece_Test_3, King) {
    _legal_moves_expected[6][6] = true;
    _legal_moves_expected[6][7] = true;

    _legal_moves_output = _board->get_piece(7,7)->legal_moves(7,7);

    ASSERT_EQ(compare(_legal_moves_output, _legal_moves_expected), true);
}


TEST_F(Piece_Test_3, Queen) {
    _legal_moves_expected[6][6] = true;
    _legal_moves_expected[7][5] = true;
    ...
    _legal_moves_expected[4][7] = true;
    _legal_moves_expected[3][7] = true;

    _legal_moves_output = _board->get_piece(5,7)->legal_moves(5,7);

    ASSERT_EQ(compare(_legal_moves_output, _legal_moves_expected), true);
}


TEST_F(Piece_Test_3, Knight) {
    _legal_moves_expected[6][7] = true;
    _legal_moves_expected[6][5] = true;

    _legal_moves_expected[2][7] = true;
    _legal_moves_expected[2][5] = true;

    _legal_moves_expected[5][4] = true;
    _legal_moves_expected[3][4] = true;

    _legal_moves_output = _board->get_piece(4,6)->legal_moves(4,6);
